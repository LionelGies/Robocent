...
class TextMessagesControllerTest < ActionController::TestCase
  ...
  test "should create text_message" do
    assert_difference('TextMessage.count') do
      post :create, text_message: { content: @text_message.content, list_id: @text_message.list_id, sending_option: @text_message.sending_option, test_send_to: @text_message.test_send_to }
    end
  ...
  test "should update text_message" do
    put :update, id: @text_message, text_message: { content: @text_message.content, list_id: @text_message.list_id, sending_option: @text_message.sending_option, test_send_to: @text_message.test_send_to }
    assert_redirected_to text_message_path(assigns(:text_message))
  end
